...
const OTTBox = ({
	...
	>
		<div
			className={cn(
				'flex flex-col justify-center items-center relative w-full gap-1 bg-gray-100 rounded-xl py-3 h-[75px] hover:bg-green-100',
				{ 'bg-green-100 border-green-300 border-2': clicked },
			)}
		>
			{clicked && (
		...
		{isAvailableMatchingImmediately && (
			<div className="flex items-center justify-between pt-1 font-medium text-green-700">
				<CheckedV />
				<small>즉시매칭 가능</small>
			</div>
		)}
